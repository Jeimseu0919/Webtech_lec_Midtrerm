<!--James-->
<link href="web/style/logo.png" rel="icon">
...
<body>
   <div id="main">
    <div id="header">
      ...
      <div id="logo">
        <div id="logo_text">
          ...
          <h1><a href="#">Web Systems and Technologies</a></h1>
          <h2>A Online Quiz</h2>
        </div>
      </div>
    ...
    <div id="site_content">
      <div id = "content">
        <h3> Welcome to Web Systems and Technologies Quiz</h3>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <button> <a href="quizList.jsp" class="button">START QUIZ</a></button>
