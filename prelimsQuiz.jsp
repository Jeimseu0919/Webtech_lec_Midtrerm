...
<html>
    ...
    <body>
        ...
        <form method="POST" action="PrelimQuizChecker">   
            ...
            <sql:query dataSource="${db}" var="rs">
                SELECT description, answer FROM questions 
                WHERE term='prelims' AND type='TrueOrFalse';
            </sql:query> 
            <table>
                <c:forEach var="questionList" items="${rs.rows}"> 
                    <tr>
            ...
            <sql:query dataSource="${db}" var="rs">
                ...
                WHERE term='prelims' AND type='Multiplechoice';
            </sql:query>
            <ol>
            ...
            <sql:query dataSource="${db}" var="rs">
                SELECT description, answer FROM questions 
                WHERE term='prelims' AND type='Matchingtype';
            </sql:query> 
            <table>
                <c:forEach var="questionList" items="${rs.rows}">
